...
// Re-export the pure tools so existing callers (ideation.mjs, tests, etc.) that
// import these names from "./runtime.mjs" keep working unchanged. util.mjs is the
// single source of truth for these implementations; runtime.mjs only forwards them.
export {
  VERSION,
  assertGitRepo,
  ensureDir,
